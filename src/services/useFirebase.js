...
export async function doesUserExists(username) {
...
export async function updateLoggedInUserFollowing(loggedInUserDocId, profileId, isFollowingProfile) {
    return firebase
        .firestore()
        .collection('users').doc(loggedInUserDocId).update({
...
export async function updateFollowedUserFollowers(profileDocId, loggedInUserDocId, isFollowingProfile) {
    // profileDocId, // currently logged in user document id (profile)
    // loggedInUserDocId, // the user requests to follow
    // isFollowingProfile // true/false (am i currently following this person?)
    return firebase
        .firestore()
        .collection('users').doc(profileDocId).update({
